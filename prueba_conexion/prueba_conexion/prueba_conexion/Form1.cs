...
namespace prueba_conexion
{
    ...
    public partial class frempleado : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            else if (pictureBox1.Text.Equals(""))
            {
            ...
            else
            {
                ...
                {
                   sql = "INSERT INTO empleados (nombre, apellido, cedula, status, sexo, fecha_nacimiento, edad, fecha_ingreso, antiguedad, salario, foto, id_cargo) VALUES ('" + txtnombre.Text + "', '" + txtapellido.Text + "', '" + txtcedula.Text + "',' ', '" + txtsexo.Text + "', '" + txtfechanacimiento.Text + "', '" + txtedad.Text + "', '" + txtfechaingreso.Text + "', '" + txtantiguedad.Text + "', '" + txtsalario.Text + "',  ' ')";
